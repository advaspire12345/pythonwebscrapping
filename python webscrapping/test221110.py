...
def inizializer(all_data):
    ...
    # PASSWORD = "Abcd5678@5678"

    USERNAME = "muhammadzulhilmibin@gmail.com"
    PASSWORD = "Abcd1234@1234"

    # USERNAME = "Eddiebinmalidas@gmail.com"
    # PASSWORD = "Abcd5678@5678"
    ...
    if command_data == 'account':
        ...
        DO_SHARES = False
        DO_COMMENT = False
    # Options selected in the interface
    ...
    # def do_multi_screenshot(element, save_file):
    #     global len_keywords_2
    #     screenshot_time = len_keywords_2 // 13
    #     import string
    #     import secrets
    #     alphabet = string.ascii_letters + string.digits
    #     rand = ''.join(secrets.choice(alphabet) for i in range(32))
    ...
    #     for i in range(screenshot_time):

    #         top = 2
    #         left = 605
    #         adj_width = size['width'] + 140

    #         # Calculate screenshot height

    #         if screenshot_time < 2:
    #             adj_height = (67 * (len_keywords_2 - 1))

    #         else:
    #             if i == 0:
    #                 adj_height = 860

    #         print('keywords length:',len_keywords_2)
    ...
    #         cropped = im.crop((left, top, right, bottom))
    #         # print(im)
    #         cropped.save(f'{save_file}{i+1}.png')  # saves new cropped image
                    ...
                    if '/ads/' in e.get_attribute('innerHTML'):
                        ...
                        for i in range(10):
                            try:
                                ...
                                copywriting_box = e.find_element(By.XPATH,'//div[@class="x78zum5 xdt5ytf xz62fqu x16ldp7u"]')
                            except:
                                sleep(0.5)
